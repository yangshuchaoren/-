    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li><a href="#">项目跟踪</a></li>
                <li><a href="#">项目评论</a></li>
                <li class="active"><a href="all_classity.html">项目分类*</a></li>
                <li><a href="#">项目推荐</a></li>
            </ul>
            <ul class="nav nav-sidebar">
                <li><a href="">注册用户</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">
                        项目分类列表  <a class="btn btn-primary" href="add_classity.html">添加</a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-toggle="modal"
                                       data-target="#myModal" onclick="getTable(1,'慈善众筹','XXXXXXXXXXX','2018-05-11','可用')">详情/修改</a> |
