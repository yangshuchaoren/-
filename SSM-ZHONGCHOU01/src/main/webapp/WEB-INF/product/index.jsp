...
<div id="header">
    ...
    <c:choose>
            <c:when test="${user==null}">
             <a href="login" id="denglu">登录</a>
             <span id="username"></span>
             <span style="color: white;">|</span>
             <a href="forregister">注册</a>
             <a href="forshiming">管理员登录</a>
             <a href="foradmin">你好</a>
                   </c:when>
                   <c:otherwise>
                    <img src="upload/user/${user.image}" id="img3"/>
                   </c:otherwise>
       </c:choose>
        </div>
    </div>
...
<!-- Swiper -->
  <div class="swiper-container">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="images/1525661829.jpg"></div>
      <div class="swiper-slide"><img src="images/1525661991.png"> </div>
    </div>
    <!-- Add Pagination -->
...
<div class="content">
    ...
    <div class="index-mrjx">
        ...
        <div class="index-mrjx_min"><a href=""><img src="images/pruduct1_32.jpg" alt=""></a></div>
        <div class="index-mrjx_right">
            <div class="index-pruduct">
                <ul>
                    <li>
                        <div class="index-plidiv1"><a href=""><img src="upload/project/${project[0].fileid}" width="237px" height="155px" alt=""></a><div class="index-p_dkz">等款中</div>
                        </div>  <p>
                        <a href="seedetail/${project[0].id}">NGDS新游戏手柄 手机一秒变游戏机</a></p>
        ...
        <div class="index-mrjx_botto">
            <div class="index-pruduct">
                <ul>
                    <li>
                        <div class="index-plidiv1"><a href=""><img src="upload/project/${project[1].fileid}" width="237px" height="155px" alt=""></a><div class="index-p_dkz">等款中</div>
                        </div>  <p>
                        <a href="">NGDS新游戏手柄 手机一秒变游戏机</a></p>
                        <div class="index-pli-bot">
                            <dl>
                    ...
                    <li>
                        <div class="index-plidiv1"><a href=""><img src="images/pruduct2_34.jpg" width="237px" height="155px" alt=""></a><div class="index-p_dkz">等款中</div>
                        </div>  <p>
                        <a href="">NGDS新游戏手柄 手机一秒变游戏机</a></p>
                        <div class="index-pli-bot">
                            <dl>
    ...
    <div class="ggt2"><a href=""><img src="images/ggt2_39.jpg" alt=""></a></div>
...
<div class="index-jjks">
    ...
    <div class="index-jjkscon">
        <ul>
            <li>
             <div class="index-jjkscon1"><a href=""><img src="images/producc_47.jpg" width="238" height="155" alt=""></a><div class="index-j_dkz">预热中</div></div>
                <div><a href="">NGDS新游戏手柄 手机一秒变游戏机</a></div>
                <div><i>目标金额：<span>50000.00</span></i><b>上线日期<span>06/03</span></b></div>
            </li><li>
             <div class="index-jjkscon1"><a href=""><img src="images/producc_47.jpg" width="238" height="155" alt=""></a><div class="index-j_dkz">预热中</div></div>
                <div><a href="">NGDS新游戏手柄 手机一秒变游戏机</a></div>
            <div><i>目标金额：<span>50000.00</span></i><b>上线日期<span>06/03</span></b></div>
...
<div class="ggt2 ggt3"><a href=""><img src="images/ggt2_39.jpg" alt=""></a></div>
<div class="index-jjks">
    ...
    <div class="index-jjkscon">
        <ul>
            <li>
             <div class="index-jjkscon1"><a href=""><img src="images/producc_47.jpg" width="238" height="155" alt=""></a><div class="index-j_dkz">预热中</div></div>
                <div><a href="">NGDS新游戏手柄 手机一秒变游戏机</a></div>
                <div><i>已获得：<span>50000.00</span></i><b>支持人数<span>5888</span></b></div>
            </li><li>
             <div class="index-jjkscon1"><a href=""><img src="images/producc_47.jpg" width="238" height="155" alt=""></a><div class="index-j_dkz">预热中</div></div>
                <div><a href="">NGDS新游戏手柄 手机一秒变游戏机</a></div>
            <div><i>已获得：<span>50000.00</span></i><b>支持人数<span>5888</span></b></div>
            ...
            <div class="index_tab">
                <dl class="index_tab1">
                    ...
                    <div class="index_tab1_5">
                        <a><i><img src="images/index-tbpu_07.jpg"></i>支持人数<span>63</span></a>
                        <a><i><img src="images/index-tbpu_10.jpg"></i>剩余时间<span>28天</span></a>
                    </div>
...
<div class="ggt2 ggt4"><a href=""><img src="images/ggt2_39.jpg" alt=""/></a></div>-->
</div>
<div id="bottom">
    <div class="bot-con1">
        <ul>
