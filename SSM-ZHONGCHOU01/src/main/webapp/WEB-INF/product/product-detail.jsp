    ...
    <div class="heade-con">
        ...
        <div class="nav posa">
            <ul>
                ...
                <li><a href="new_product.html" style="">发布项目</a></li>
            </ul>
        </div>
        <div class="search">
            <form action="">
...
<div class="p-detail_contit">
    ...
    <div class="p-detail_cfx2">
        <ul>
            ...
            <li class="p-detail_cfx2-4">金融</li>
        </ul>
    </div>
    </div>
...
<div class="p-detail_txt1">
    ...
    <h3>项目介绍</h3>
    <div><img src="upload/project/${project[0].fileid }" alt=""/></div>
    <p>
    ...
    <div><img src="images/pu-s2_11.png" alt=""/></div>
           ...
           <p>标签：<a href="">短片</a><a href="">电影</a><a href="">bilding</a><a href="">love</a></p>
                <div class="detail-bott2"><i><img src="images/zcvprod-a_32.png" alt=""/></i>如果你对项目有疑问，可以发起咨询<span><a href="javascript:void(0);">对发起人提问</a></span></div>
<div class="textarea1">
    ...
    <form action=""><input class="textarea2-tji" type="submit" value="提交" /></form>
        ...
        <div class="p-detail_con2r">
            <div class="p-detail_con2r1">
                ...
                <div class="bot-con1zti"><img src="images/zcvprod-a_20.png" alt=""/></div>
                <div class="p-detail_con2r1tit">目前累计金额</div>
<div class="p-detail_con2r1min">￥600000.00</div>
...
<div class="loading-bar">
                ...
                <p><span>目标</span><i>115555555.00</i></p><br>
                <p><span>剩余</span><i>115555555.00</i></p><br>
                <p><span>支持者</span><i>1155555</i></p>
                <p class="loading-barcolo">项目截止时间：2016年10月25日19时40分</p>
            ...
            <div class="loading-bzcz">
                ...
                <div class="detali-fqrxx">
                    <div class="detali-fqrxx_header">
                        <img src="upload/user/${user.image }" alt=""/></div>
                    <div class="detali-fqrxx_text">
                        <p>fanwe</p>
                        <p>上次登陆时间：2015/5/7</p>
                        <p class="h"><i><img src="images/dt_03.png" alt=""/></i><s>福建 福州</s><h2><img
