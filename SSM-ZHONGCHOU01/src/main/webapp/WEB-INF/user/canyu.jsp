    ...
    <div class="heade-con">
        ...
        <div class="search">
            <form action="">
                ...
                <input type="submit" class="search-but" value="提交">
            </form>
        </div>
...
<ul>
    ...
    <li><i class="i2"></i><a href="forfaqi">参与的项目</a></li>
    <li><i class="i4"></i><a href="forzan">点赞的项目</a></li>
    <li><i class="i6"></i><a href="found">资金管理</a></li>
    <li><b class="a-tit" href="">消息管理</b></li>
    <li><i class="i4"></i><a href="seeping">我的评论</a></li>
    <li><i class="i4"></i><a href="">我的私信</a></li>
    <li><b class="a-tit" href="">个人设置</b></li>
    <li><i class="i7"></i><a href="userinforchange">资料修改</a></li>
   ...
   <c:choose>
     <c:when test="${user.state=='1'}">
            <li><a class="vcolor" href="index.html">首页</a></li>
                 ...
                 <c:otherwise>
              <li><i class="i10"></i><a href="forshiming">实名认证</a></li>
             </c:otherwise>
    </c:choose>
