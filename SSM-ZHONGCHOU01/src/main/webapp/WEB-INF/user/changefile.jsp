...
<div class="user-conr_tab">
    <ul>
        <li class="cur">用户信息</li>
        
    </ul>
</div>
        <div class="user-conr_tab2">
<form class="form-horizontal" action="changeuser" enctype="multipart/form-data" method="post">
    <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
    <div class="col-sm-10">
      <input type="text" class="form-control"  name="telnumber" id="inputEmail3" value="${user.telnumber }">
     </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">密码</label>
    <div class="col-sm-10">
      <input type="text" class="form-control"  name="password"id="inputPassword3" value="${user.password }">
    </div>
  </div>
    <div class="form-group">
  ...
  <!-- 用户的头像的查看 -->
  <img src="upload/user/${user.image }" alt="" class="img-circle">
     <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">用户头像</label>
    <div class="col-sm-10">
     更换头像 <input type="file" class="form-control" id="inputPassword3" name="file">
    </div>
  </div>
  <div class="form-group">
