...
<div class="user-conr_tab">
    <ul>
        ...
        <div id="d1">
  <form action="shiming" enctype="multipart/form-data" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">姓名</label>
    <input type="text"  name="name" class="form-control" id="exampleInputEmail1" placeholder="姓名" value="${user.name}" readonly="readonly">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">身份证号</label>
    <input type="text"  name="idnumber" class="form-control" id="exampleInputPassword1" placeholder="身份证号" value="${user.idnumber }" readonly="readonly">
  </div>
  <div class="form-group">
    <label for="exampleInputFile">身份证正面</label>
    <input type="file" id="exampleInputFile" name="file1">
    <p class="help-block">身份证正面</p>
  </div>
   <div class="form-group">
    <label for="exampleInputFile">身份证背面</label>
    <input type="file" id="exampleInputFile" name="file2">
    <p class="help-block">身份证背面</p>
  </div>
  <button type="submit" class="btn btn-default" onclick="tijiao()">提交认证</button>
</form>
</div>
<div id="d2">
<!-- 进行审核信息的查询 -->
